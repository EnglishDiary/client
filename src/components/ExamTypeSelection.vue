<template>
    <q-page class="flex flex-center">
        <div class="q-pa-md" style="width: 100%; max-width: 600px;">
            ...
            <div class="q-mb-lg">
                <h3 class="text-h5 q-mb-sm">{{ $t('wordScramble.practiceType') }}</h3>
                <q-btn-toggle v-model="selectedExamType" :options="examTypeOptions" class="full-width" spread />
            </div>

            <div class="q-mb-lg">
                <h3 class="text-h5 q-mb-sm">{{ $t('wordScramble.numberOfSentences') }}</h3>
            ...
            <div class="q-mt-lg">
                <q-btn color="secondary" :label="$t('wordScramble.start')" @click="startExam" :disable="!isFormValid" class="full-width" />
            </div>
        </div>
    </q-page>
</template>
...
const examTypeOptions = [
    { label: 'Word Scramble', value: 'word_placement' },
