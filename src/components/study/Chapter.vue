...
<template>
    <q-dialog v-model="showPublishModal">
        <q-card style="min-width: 350px">
            ...
            <q-card-section>
                <q-input label="제목" v-model="chapterSaveForm.name" :rules="[val => !!val || '필수 입력 항목입니다']">
                </q-input>
            </q-card-section>

            <q-card-section>
                <q-input v-model="chapterSaveForm.desc" label="부연설명" filled type="textarea" rows="3" autogrow />
            </q-card-section>
    ...
    <div class="q-pa-md row items-start q-gutter-md">
        <div>
            <q-btn @click="openPublishModal">챕터 추가하기</q-btn>
        </div>
    </div>
