...
const API_LIST = {
    ...
    VERIFY_USER: {
        method: GET,
        path: `${API_SERVER_CALL_URL}/user/me`,
        desc: '유저 인증',
    },
    FIND_WORD: (word) => ({
        method: GET,
        path: `${API_SERVER_CALL_URL}/word/${word}`,
        desc: '단어 조회'
    }),
    SAVE_WORD: (word) => ({
        method: POST,
        path: `${API_SERVER_CALL_URL}/word/save/${word}`,
        desc: '단어 저장'
    }),
    GET_USER_WORDS: {
        method: GET,
        path: `${API_SERVER_CALL_URL}/word/list`,
        desc: '유저 단어 목록 조회'
    },
    GET_USER_WORDS_BY_CATEGORY: (categoryId) => ({
        method: GET,
        path: `${API_SERVER_CALL_URL}/word/${categoryId}/list`,
        desc: '카테고리별 유저 단어 목록 조회'
    }),
    DELETE_WORD: (word) => ({
        method: DELETE,
        path: `${API_SERVER_CALL_URL}/word/delete/${word}`,
        desc: '유저 단어 삭제'
    }),
    UPDATE_WORD: (word) => ({
        method: POST,
        path: `${API_SERVER_CALL_URL}/word/update/${word}`,
        desc: '유저 단어 수정'
    }),
    GET_USER_CATEGORIES: {
        method: GET,
        path: `${API_SERVER_CALL_URL}/word/category`,
        desc: '유저 단어장 카테고리 조회'
    },
    REQUEST_AI_CORRECTION: {
        method: POST,
        path: `${API_SERVER_CALL_URL}/diary/ai-correction`,
        desc: '영어일기 AI 첨삭 요청'
    },
    GET_OFFICIAL_DIARY_CATEGORIES: {
        method: GET,
        path: `${API_SERVER_CALL_URL}/diary/category/official`,
        desc: '다이어리 공식 카테고리 조회'
    },
    PUBLISH_DIARY: {
        method: POST,
        path: `${API_SERVER_CALL_URL}/diary/save`,
        desc: '영어일기 발행'
    },
    ...
    FETCH_DIARY_DETAIL: (diaryId) => ({
        method: GET,
        path: `${API_SERVER_CALL_URL}/diary/${diaryId}/detail`,
        desc: '유저 다아어리 상세 조회 '
    }),
    UPDATE_USER_WORD_CATEGORY: {
        method: POST,
        path: `${API_SERVER_CALL_URL}/user/word/category/update`,
        desc: '유저 단어장 카테고리 업데이트'
    },
    REQUEST_AI_EXPRESSION: {
        method: POST,
        path: `${API_SERVER_CALL_URL}/expression/ai-correction`,
        desc: 'AI 영어작문 요청'
    },
    SAVE_EXPRESSION: {
        method: POST,
        path: `${API_SERVER_CALL_URL}/expression/save`,
        dess: '영어표현 저장'
    },
    FETCH_EXPRESSIONS: {
        method: GET,
